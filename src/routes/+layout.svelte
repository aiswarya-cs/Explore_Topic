...
<div class="fixed z-50 w-full bg-transparent transition-all">
  <nav
    class={`flex items-center border-b-[0.5px] border-b-gray-50 justify-between px-5 md:px-24 py-4 ${scrolled ? "bg-[#80d0c7]" : "bg-transparent"} transition-colors duration-300`}
  >
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
        <div>
          ...
          <ul class="text-gray-500 dark:text-gray-400 font-medium space-y-2">
            ...
            <li>
              <a href="#how-it-works" class="relative group inline-block text-[#80d0c7]">
                How it Works
                <span
                  class="absolute left-0 bottom-0 w-0 h-[2px] bg-[#80d0c7] transition-all duration-300 ease-in-out group-hover:w-full"
                ></span>
            ...
            <li>
              <a href="#faq" class="relative group inline-block text-[#80d0c7]">
                FAQ's
                <span
                  class="absolute left-0 bottom-0 w-0 h-[2px] bg-[#80d0c7] transition-all duration-300 ease-in-out group-hover:w-full"
                ></span>
        ...
        <div>
          ...
          >
          <select name="" id="" class="bg-transparent text-white">
